...
40. 查询有关教师的签到任务列表 `172`
	* `17200` 非教师用户无权限

41. 获取学生新的签到任务 `173`
	* `17300` 非学生无法查询新签到任务

42. 教师添加附加信息到签到任务中 `174`
	* `17400` 非教师用户，无权限
	* `17401` 非法签到任务ID
	* `17402` 附加信息为空
	* `17403` 未找到对应的签到
...
47. 学生获取自己的单个签到记录信息 `179`
	* `17900` 非学生
	* `17901` 非法参数值
	* `17902` 未找到记录

48. 从教学信息库中获取相应的信息 `180`
